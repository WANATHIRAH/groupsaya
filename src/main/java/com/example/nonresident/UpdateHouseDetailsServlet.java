...
@MultipartConfig
@WebServlet(name = "UpdateHouseDetailsServlet", value = "/UpdateHouseDetailsServlet")
public class UpdateHouseDetailsServlet extends HttpServlet {
    @Override
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try{
            ...
            String hName    = request.getParameter("hNameu");
